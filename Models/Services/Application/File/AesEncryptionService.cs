...
namespace StorageMicroService.Models.Services.Application.Storage
{
    public class AesEncryptionService
    {
        ...
        private async static Task<bool> ExecuteEncryptionDecription(Stream input, Stream output, CryptoStreamMode cryptoStreamMode, byte[] password, byte[] salt)
        {
        ...
        public static async Task<bool> EncryptStreamAsync(Stream input, Stream output, byte[] password, byte[] salt)
        {
            return await ExecuteEncryptionDecription(input, output, CryptoStreamMode.Write, password, salt);
        }
        public static async Task<bool> DecryptStreamAsync(Stream input, Stream output, byte[] password, byte[] salt)
        {
            return await ExecuteEncryptionDecription(input, output, CryptoStreamMode.Read, password, salt);
        }
